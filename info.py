...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002387618380') 
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002387618380') # add multiple channels here, separated by single space
